...
public class BallModel {
	 ...
	 */
	public void loadBall(IUpdateStrategy ballname, IPaintStrategy paint) {
		...
		CBall ball = new CBall(loc, Radius, vel, color, canvas, ballname, paint);
	...
	private IStrategyFac _errorStrategyFac = new IStrategyFac() {
		...
		public IUpdateStrategy make() {
			return new IUpdateStrategy() {
				 ...
				 */
				@Override
				public void updateState(CBall context, Dispatcher dispacher) {
					if (25 < count++) {
