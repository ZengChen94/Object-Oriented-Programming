...
/**
 * The CollideStrategy, every time it interact, the context and target will collide
 * @author Ye Wang
 * @author Chen Zeng
 * @version 1.0
 */

//reference for CollideStrategy: https://www.clear.rice.edu/comp504/f17/lectures/lec15/index.html
public class CollideStrategy<TDispMsg> implements IUpdateStrategy<TDispMsg> {
