...
/**
 * 
 * The BreathingAndWanderBall is a subclass of ABall.
 * 
...
public class BreathingAndWanderBall extends ABall {
	private int cnt = 20;
	 ...
	 */
	public BreathingAndWanderBall(Point location, int radius, Point velocity, Color color, Component canvas) {
		super(location, radius, velocity, color, canvas);
	}

	/**
	 * Random change the radius and velocity of the ball.
	 */
	@Override
