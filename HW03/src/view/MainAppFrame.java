 ...
 * @author ker7
 */
public class MainAppFrame<TDropListItem> extends JFrame {
	/**
	 ...
	 */
	private final JButton btnClearBalls = new JButton("ClearAll");
	 ...
	 */
	private IModelCtrlAdapter<TDropListItem> _view2ModelCtrlAdpt;
	...
	/**
	 * Panel for holding the textField and the AddToLists button
	 */
	private final JPanel panel_1 = new JPanel();

	/**
	 * Panel for holding the button to make selected balls, the button to combine two ball strategies, and the two droplists
	 */
	private final JPanel panel_2 = new JPanel();

	/**
	 * Panel for holding the application's ball strategy switching functionallity
	 */
	private final JPanel panel_3 = new JPanel();

	/**
	 * Panel for holding the button to clear all of the balls
	 */
	private final JPanel panel_4 = new JPanel();

	/**
	 * Button to add a strategy type to both droplists
	 */
	private final JButton btnAddToList = new JButton("Add to lists");

	/**
	 * The first combo box that functions as a Droplist for holding the different ball strategies
	 */
	private final JComboBox<TDropListItem> comboBox_2 = new JComboBox<TDropListItem>();

	/**
	 * The second combo box that functions as a Droplist for holding the different ball strategies
	 */
	private final JComboBox<TDropListItem> comboBox_1 = new JComboBox<TDropListItem>();

	/**
	 * The button for combining two ball strategies into a single ball
	 */
	private final JButton btnCombine = new JButton("Combine!");

	/**
	 * The button used to switch the switcher ball's strategy
	 */
	private final JButton btnSwitch = new JButton("Switch!");

	/**
	 * The Button used to make a ball that has the ability to switch its strategy
	 */
	 ...
	 */
	public MainAppFrame(IModelPaintAdapter _view2ModelPaint, IModelCtrlAdapter<TDropListItem> _view2ModelCtrl) {
		initGUI();
	...
	private void initGUI() {
		...
		panel_1.add(txtfEnterBallClass);
		txtfEnterBallClass.setToolTipText("Text field to enter ball class");
		txtfEnterBallClass.setText("Straight");
		txtfEnterBallClass.setColumns(10);
		btnAddToList.setToolTipText("Click to add a ball strategy to the droplists");
		btnAddToList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TDropListItem o = _view2ModelCtrlAdpt.addStrategy(txtfEnterBallClass.getText());
				if (null == o)
					return; // just in case
		...
		btnMakeBall.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				_view2ModelCtrlAdpt.loadBall(comboBox_1.getItemAt(item_pos));
			}
		});
		comboBox_1.setToolTipText("Select a ball strategy from this list");

		panel_2.add(comboBox_1);
		comboBox_2.setToolTipText("Select a ball strategy from this list for combining ball stratigies");

		panel_2.add(comboBox_2);
		btnCombine.setToolTipText("Click to combine two strategies into a single ball");
		btnCombine.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TDropListItem o = _view2ModelCtrlAdpt.combineStrategies(
						comboBox_1.getItemAt(comboBox_1.getSelectedIndex()),
						comboBox_2.getItemAt(comboBox_2.getSelectedIndex()));
				if (null == o)
					return; // just in case
				comboBox_1.insertItemAt(o, 0);
				comboBox_2.insertItemAt(o, 0);
		...
		panel_2.add(btnCombine);

		pnlNorth.add(panel_3);
		panel_3.setLayout(new GridLayout(0, 1, 0, 0));
		btnMakeSwitcher.setToolTipText("Click to create a ball that can switch strategies");
		btnMakeSwitcher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				_view2ModelCtrlAdpt.makeSwitcherBall();
			}
		});

		panel_3.add(btnMakeSwitcher);
		btnSwitch.setToolTipText("Click to switch the switching ball stratigies to their other strategy");
		btnSwitch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				_view2ModelCtrlAdpt.switchStrategy(comboBox_1.getItemAt(comboBox_1.getSelectedIndex()));
			}
		});

		panel_3.add(btnSwitch);

		pnlNorth.add(panel_4);
		panel_4.setLayout(new GridLayout(0, 1, 0, 0));
		panel_4.add(btnClearBalls);
