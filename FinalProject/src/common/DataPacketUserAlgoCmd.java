 ...
 */
public abstract class DataPacketUserAlgoCmd<T extends IUserMessageType> extends ADataPacketAlgoCmd<String, T, String, IUserCmd2ModelAdapter, DataPacketUser<T>> {
